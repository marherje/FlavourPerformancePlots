...
void CSLumi500_new(TString pol){
  ...
  TString folder="/lustre/ific.uv.es/prj/ific/flc/ntuples-2022/merged_small_"; //merged_small_eL_pR_500GeV_FullOpt.root;
  ...
  file=folder+pol+"_500GeV_FullOpt.root"; 
  ...
  Long64_t N_signal_allq = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])<50");
  //Long64_t N_signal_t = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])<35 && fabs(mc_quark_pdg[0])==6 && fabs(mc_quark_pdg[1])==6 ");
  Long64_t N_signal_b = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])<50 && fabs(mc_quark_pdg[0])==5 && fabs(mc_quark_pdg[1])==5 ");
  Long64_t N_signal_c = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])<50 && fabs(mc_quark_pdg[0])==4 && fabs(mc_quark_pdg[1])==4 ");
  Long64_t N_signal_s = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])<50 && fabs(mc_quark_pdg[0])==3 && fabs(mc_quark_pdg[1])==3 ");
  Long64_t N_signal_u = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])<50 && fabs(mc_quark_pdg[0])==2 && fabs(mc_quark_pdg[1])==2 ");
  Long64_t N_signal_d = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])<50 && fabs(mc_quark_pdg[0])==1 && fabs(mc_quark_pdg[1])==1 ");

  
  Long64_t N_ISR_allq = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])>50");
  //Long64_t N_ISR_t = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])>35 && fabs(mc_quark_pdg[0])==6 && fabs(mc_quark_pdg[1])==6 ");
  Long64_t N_ISR_b = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])>50 && fabs(mc_quark_pdg[0])==5 && fabs(mc_quark_pdg[1])==5 ");
  Long64_t N_ISR_c = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])>50 && fabs(mc_quark_pdg[0])==4 && fabs(mc_quark_pdg[1])==4 ");
  Long64_t N_ISR_s = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])>50 && fabs(mc_quark_pdg[0])==3 && fabs(mc_quark_pdg[1])==3 ");
  Long64_t N_ISR_u = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])>50 && fabs(mc_quark_pdg[0])==2 && fabs(mc_quark_pdg[1])==2 ");
  Long64_t N_ISR_d = tree->GetEntries("(mc_ISR_E[0]+mc_ISR_E[1])>50 && fabs(mc_quark_pdg[0])==1 && fabs(mc_quark_pdg[1])==1 ");
